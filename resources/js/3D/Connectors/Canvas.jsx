...
export default function Scene() {
  ...
  return (
    <Canvas onClick={click} shadows dpr={[1, 1.5]} gl={{ antialias: false }} camera={{ position: [0, 0, 15], fov: 37, near: 1, far: 20 }}>
      ...
      {/* <Environment resolution={256} path="./hdri/" files="potsdamer_platz_1k.hdr">
...
function Model({ children, color = 'white', roughness = 0, ...props }) {
  const ref = useRef()
  const { nodes, materials } = useGLTF('/c-transformed.glb','./draco/')
  useFrame((state, delta) => {
